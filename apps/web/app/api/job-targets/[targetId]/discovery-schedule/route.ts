...
function problemResponse(error: unknown): Response {
  ...
  const allowed = new Set(["JOB_DISCOVERY_SCHEDULE_VERSION_CONFLICT", "SOURCE_POLICY_REQUIRED", "JOB_DISCOVERY_SCHEDULE_TARGET_INACTIVE", "NO_SUPPORTED_SOURCE", "PROFILE_UNAVAILABLE", "ACCOUNT_RUN_POLICY_WINDOW_CLOSED", "RUN_PREFLIGHT_BLOCKED"]);
