...
function evidenceText(evidence: RunPreflightEvidence): string {
  ...
  if (evidence.kind === "model_diagnostic") return `模型连接状态：${evidence.status}`;
