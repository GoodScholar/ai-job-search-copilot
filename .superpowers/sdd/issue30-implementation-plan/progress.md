...
Task 10: fix round 4/5 (3 addressed — query discriminator、canonical/final identity、complete run secret exclusion 均取得各自 committed mutation Red→Green；commits `218a8f2..e64a260`；报告 `task-10-report.md`)。
