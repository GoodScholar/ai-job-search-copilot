...
export const recommendationDecisionEvents = pgTable("recommendation_decision_events", {
  ...
  unique("recommendation_decision_events_user_key_unique").on(table.userId, table.idempotencyKey), unique("recommendation_decision_events_user_id_id_unique").on(table.userId, table.id), index("recommendation_decision_events_current_idx").on(table.userId, table.recommendationListItemId, table.createdAt, table.id),
