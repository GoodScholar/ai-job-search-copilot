...
export const RecommendationItemSchema = z.object({
  ...
  displayBand: RecommendationBandSchema, highlighted: z.boolean(), ordinal: z.int().min(1).max(10), jobEvidence: z.array(RecommendationEvidenceSchema).max(20), profileEvidence: z.array(RecommendationEvidenceSchema).max(20), assessment: z.unknown(),
}).strict();
